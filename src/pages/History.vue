...
<template>
  <div class="h-screen">
      <div class="flex">
        <h1 class="font-sans text-2xl text-gray-900 font-bold dark:text-gray-400 mx-auto flex">История аннотирования</h1>
      </div>

      <div class="full flex justify-center">
        <div class="flex-col">
          <div v-for="item in historyAnnotation" :key="item.id" class="w-auto mt-4 p-4 bg-gray-100 rounded-3xl shadow-xl hover:bg-gray-200 
